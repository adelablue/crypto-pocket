            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input id="coin-ticker" v-model="ticker" type="text">
                    </div>
                    <div class="form-group">
                        <label for="coin-name">Name</label>
                        <input id="coin-name" v-model="name" type="text">
                    </div>
                    <div class="form-group">
                        <label for="coin-url">API URL</label>
                        <input id="coin-url" v-model="apiURL" type="text">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" @click.prevent="save">
                    Save Currency</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" @click.prevent="hidden">
                    Close</button>
                </div>
            </div>
